...
/**
 * Tipos de recursos disponibles para el negocio
 */
const AVAILABLE_RESOURCE_TYPES = [
  { id: 'sombrilla', name: 'Sombrillas', emoji: '☂️', prefix: 'S' },
  { id: 'carpa', name: 'Carpas', emoji: '⛺', prefix: 'C' },
  { id: 'sombrillon', name: 'Sombrilones', emoji: '🏖️', prefix: 'SM' },
  { id: 'estacionamiento', name: 'Estacionamiento', emoji: '🚗', prefix: 'E' },
  { id: 'cabana', name: 'Cabañas', emoji: '🏠', prefix: 'CB' },
  { id: 'dormi', name: 'Dormis', emoji: '🛏️', prefix: 'D' },
  { id: 'habitacion', name: 'Habitaciones', emoji: '🚪', prefix: 'H' },

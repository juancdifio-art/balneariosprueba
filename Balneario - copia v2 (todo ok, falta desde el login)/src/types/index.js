 ...
 * @property {'sombrilla'|'carpa'|'estacionamiento'} type - Tipo de recurso alquilado
 * @property {number} unitNumber - Número de la unidad (1-50 para sombrillas/carpas, 1-100 para estacionamiento)
 ...
 * @property {'sombrilla'|'carpa'|'estacionamiento'} type - Tipo de recurso
 * @property {number} total - Cantidad total de unidades
 * @property {string} prefix - Prefijo para mostrar (S, C, E)
